...
// function App() {
//   // Replace `any` with appropriate type (e.g., Post[], etc.)
//   const { data, error, isLoading, isSuccess, isError } = useGetAllPostQuery();
//   // const { data, error, isLoading, isSuccess, isError } = useGetPostByIdQuery(11);
//   // const { data, error, isLoading, isSuccess, isError } = useGetPostByLimitQuery(3);
//   // const [deletePost, { isLoading: isDeleteLoading, isSuccess: isDeleteSuccess }] = useDeletePostMutation();
//   // const [createPost, { isLoading: isCreateLoading, isSuccess: isCreateSuccess }] = useCreatePostMutation();
//   // const [updatePost, { isLoading: isUpdateLoading, isSuccess: isUpdateSuccess }] = useUpdatePostMutation();
...
//   if (isError && error) return <h1>An error occurred: {error.toString()}</h1>;
